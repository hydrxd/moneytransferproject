Your task is to design and implement a eward module that sits on top of this system and incetivizes users for eligible transactions while maintaining the history of rewards granted to the user.
